...
#     criterion = nn.MSELoss()
    ...
    checkpoint_callback = ModelCheckpoint("/Users/kpmac/Documents/IITB/DS593/model/checkpoints/nn3_" + str(i) + ".pth")
    loss_list = []
    ...
    model.load_state_dict(torch.load("/Users/kpmac/Documents/IITB/DS593/model/checkpoints/nn3_" + str(i) + ".pth"))
    model.eval()
    with torch.no_grad():
